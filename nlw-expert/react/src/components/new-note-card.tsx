...
export function NewNoteCard({ onNoteCreated }: NewNoteProps) {
    const [shouldShowOnBoard, setShouldShownOnBoard] = useState(true);
    const [isRecording, setIsRecording] = useState(false);
    const [content, setContent] = useState("");

    function handleStartEditor() {
        setShouldShownOnBoard(false);
    }
    ...
    return (
        <Dialog.Root>
            <Dialog.Trigger className="rounded-md flex flex-col text-left bg-slate-700 gap-3 p-5 outline-none hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
